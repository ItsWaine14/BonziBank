<footer class="bg-[#424874] text-[#dcd6f7]">
        <div class="mx-auto w-full max-w-screen-xl p-4 py-4 lg:py-8">
            <div class="md:flex md:justify-between">
                <div class="mb-4 md:mb-0">
                    <a class="flex items-center">
                        <img src="{{ asset('logo.png') }}" class="h-6 me-3" alt="Bonzi Logo" />
                        <span class="self-center text-2xl font-semibold whitespace-nowrap ">Bonzi</span>
                    </a>
                </div>
                <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                    <div>
                        <h2 class="mb-1 text-sm font-semibold text-[#dcd6f7] uppercase ">Resources</h2>
                    ...
                    <div>
                        <h2 class="mb-1 text-sm font-semibold text-[#dcd6f7] uppercase ">Legal</h2>
                        <ul class="text-[#a6b1e1] font-medium">
                            <li class="mb-4">
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm sm:text-center text-[#dcd6f7]">© 2025 Bonzi. All Rights Reserved.
                </span>
                <div class="flex mt-4 sm:justify-center sm:mt-0">
                    ...
                    <a href="https://github.com/ItsWaine14/BonziBank" class="text-[#dcd6f7] hover:text-[#ffca22] dark:hover:text-white ms-5">
